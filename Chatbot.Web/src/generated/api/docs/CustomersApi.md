...
| [**updateCustomer**](CustomersApi.md#updatecustomeroperation) | **PATCH** /api/teams/{teamId}/customers/{customerId} |  |
...
> CustomerResponse updateCustomer(teamId, customerId, updateCustomerRequest)
